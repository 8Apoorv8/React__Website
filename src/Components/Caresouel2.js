        ...
        <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
          ...
          >
            {/* <img
              ...
              //   alt="Motorbike Smoke"
            /> */}
            <div class="absolute inset-x-[15%] bottom-5  py-5  text-black md:block block  w-full h-[100vh] md:h-auto">
          ...
          >
            ...
            <div class="absolute inset-x-[15%] bottom-5  py-5  text-black md:block">
              <div className="absolute text-3xl -top-[480px] left-0 flex flex-col gap-6 md:gap-8">
                ...
                <div className="overflow-hidden">
                  <h2 className="font-light text-2xl  text-[#2a3855] ">
                    We look forward to help you in taking<br></br> your company
                    to new height.
                  </h2>
                </div>
                <div className="overflow-hidden">
